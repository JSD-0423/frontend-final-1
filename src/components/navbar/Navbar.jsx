...
const Navbar = () => {
  ...
  return (
    <Stack direction='row' spacing={{xs:0, sm:0, md:1,lg:2}} width='100%' alignItems='center'>
      ...
      <Typography lineHeight='18px' fontSize="14px">Handbags</Typography>
      <Typography lineHeight='18px' fontSize="14px">Watches</Typography>
      <Typography lineHeight='18px' fontSize="14px">Skincare</Typography>
      <Typography lineHeight='18px' fontSize="14px">Jewellery</Typography>
      <Typography lineHeight='18px' fontSize="14px">Apparels</Typography>
      </Stack>
      </Box>
      ...
      <Stack direction='row' justifyContent='flex-end' alignItems="center" width="100%" spacing={2}>
        ...
        <Box display={{xs:'none', md:'block'}} component='div'>
          <IconBtn iconsNames={['FavoriteBorderOutlinedIcon','PermIdentityOutlinedIcon','LocalMallOutlinedIcon']} iconColor={theme.palette.primary.main} iconPosition={'relative'} pseudoIconId={'LocalMallOutlinedIcon'} pseudoType={'&::after'} pseudoContent={"''"} pseudoPosition={'absolute'} pseudoTopPos={'1px'} pseudoRightPos={'7px'} pseudoWidth={'7px'} pseudoHeight={'7px'} pseudoBorder={'2px solid white'} pseudoBorderRadius={'50%'} pseudoBackgroundColor={'orange'} pseudoZIndex={1} />
        </Box>
