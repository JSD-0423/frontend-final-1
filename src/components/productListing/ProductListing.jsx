  ...
  return (
    <>
      <Box display='grid' gap={{ xs: "25px 22px", md: "87px 31px" }}  gridTemplateColumns={{xs:'repeat(2 , 1fr)', md:"repeat(4 , 1fr)" }} >
        {newData.map((card)=>{
          return (
            <Link key={card.id} style={{textDecoration: "none", display:'inline-block', width:{xs:'100%', md:'100%', lg:'286px'}, height:'fit-content'}} to='/product-details'>
              <CardItem 
                cardWidth={'100%'} 
                imageHeight={'100%'} 
                imageWidth={'100%'} 
      ...
      <Stack direction='row' mt={2} width='100%' justifyContent='center' spacing={2}>
