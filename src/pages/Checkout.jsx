      ...
      >
        ...
        >
          ...
          <Stack direction="column" gap={3} mb={[0, "17px"]}>
            <CheckoutProduct
              src={"https://images2.imgbox.com/10/33/1ecsOzts_o.png"}
              styles={checkoutPTextStyles}
              pName={"Coach"}
              pDetails={"Leather Coach Bag"}
              pQuantity={"QTy-1"}
            />
            <CheckoutProduct
              src={"https://images2.imgbox.com/10/33/1ecsOzts_o.png"}
        ...
        >
          ...
          <Button
            sx={{ bgcolor: "primary.main", "&:hover": { bgcolor: "#3485b3" } }}
          >
            <Typography
              variant="body1"
              color="white"
